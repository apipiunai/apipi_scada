...
export default function FacturaGemini() {
  ...
  "detalles_factura": {
    "numero": "FAC-2020-0001",
    "fecha_emision": "16/12/2020",
    "fecha_vencimiento": "15/01/2021",
    "condiciones_pago": "30 días",
    "metodo_pago": "Transferencia bancaria",
    "referencia_pedido": "PED-2020-0042"
  },
  "datos_bancarios": {
    "banco": "Banco Ejemplo",
  ...
  "lineas_detalle": [
    {
      "sku": "SKU000002",
      "descripcion": "Pantalón Génova rayas. Color creme. Recto, pana",
      "unidades": 20,
  ...
  "totales": {
    "base_imponible_total": 800.00,
    "descuentos_total": 0.00,
    "iva_total": 168.00,
  ...
  "notas": "Factura generada automáticamente. Conserve este documento para su contabilidad."
}`
                       ...
                       contents: [
                           {
                               ...
                               parts: [
                                   {
                                       text: `haz un objeto json como esta referencia: ${objeto_referencia} no incluyas nada mas. unicamente desde "{" hasta "}". extrae los datos del pdf.`
                                   },
                                   {
                                       inlineData: {
                                           mimeType: "image/png",
  ...
  `}
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
                ...
                <div style={{ width: "100%", height: "600px", borderRadius: "8px", overflow: "hidden", border: `1px solid ${theme.border}` }}>
                    <embed src="factura.pdf" type="application/pdf" width="100%" height="100%" />
                </div>
